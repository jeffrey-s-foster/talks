...
ActiveRecord::Schema.define(version: 20160424191753) do
  ...
  create_table "lists_owners", id: false, force: :cascade do |t|
  ...
  create_table "lists_posters", id: false, force: :cascade do |t|
  ...
  create_table "lists_talks", id: false, force: :cascade do |t|
    t.integer "list_id"
    t.integer "talk_id"
  end
  ...
  create_table "talks", force: :cascade do |t|
    ...
    t.text     "speaker_affiliation", default: ""
    t.text     "reg_info",            default: ""
