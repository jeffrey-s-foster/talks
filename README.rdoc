...
* Can you include an iCal/RSS feed on the home page too, for all talks?

* For the various badges/image buttons, add tooltips using <img
  title="tooltip text" alt="long text description" ...>.
