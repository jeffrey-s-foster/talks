...
* "See all talks" is much like "All talks" which has a different
  meaning elsewhere in the same application. Maybe "All talks
  including past ones"?

* Remove create_talk permission from db

* Note when can post a talk to a list?

* Fix your past talks - reorder
