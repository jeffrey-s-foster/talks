...
* Secret keys
 * Update config/initializers/secret_token.rb with your own secret
   token. You can use `rake secret` to generate a fresh secret.
 * Edit config/devise.rb and change the value of config.secret_key.
