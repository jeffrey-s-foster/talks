...
* Global roles
  * :admin - permission to do anything on the site
    * Only :admin can create a new list
  * :poster - permission to create a talk
* Relationships
  * Each talk has_one creator (user, can't be empty)
...
* Local roles
  * A talk may be created by anyone with :poster permission
