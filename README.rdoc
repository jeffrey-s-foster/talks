...
* LDAP support for UMCP Directory IDs.  Using these is one less barrier
...
* More efficient queries in functions added to models/list.rb and models/user.rb

* Put subscribe/watch through tags on views/talks/show.html.erb
